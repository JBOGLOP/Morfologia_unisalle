...
## 📅 Ruta de aprendizaje — Segundo y Tercer corte

| Ciclo | Fechas | Tema | Estado |
|:---:|:---:|:---|:---:|
| **1** | 08 – 09 abr | Sistema Muscular | ✅ Visto |
| **2** | 15 – 16 abr | Sistema Nervioso Central y Periférico · Pares Craneales | ✅ Visto |
| **3** | 22 – 23 abr | Sistema Circulatorio · Corazón · Circulación mayor y menor | ✅ Visto |
| **4** | **29 – 30 abr** | **Sistema Linfático · Linfa · Inmunidad básica** | 🔜 **Próxima semana** |
| 5 | 06 – 07 may | **II PARCIAL** — Entrega de notas segundo corte | 📝 |
| 6 | 13 – 14 may | Sistema Endocrino · Glándulas · Hormonas básicas | ⏳ |
| 7 | 20 – 21 may | Sistema Respiratorio · Anatomía general | ⏳ |
| 8 | 27 – 28 may | **PARCIAL FINAL** | 📝 |

---

## 🗂️ Ciclo 1 · Sistema Muscular *(8 – 9 de abril)*

> *Fibras musculares · contracción básica · músculos faciales*
...
- [`01_sistema_muscular_facial.html`](./01_sistema_muscular_facial.html) — **Sistema Muscular: Fibras, Contracción y Músculos Faciales**
  ...
  - Quiz clínico integrador

---

## 🗂️ Ciclo 2 · Sistema Nervioso + Pares Craneales *(15 – 16 de abril)*

> *Encéfalo · médula · meninges · pares craneales*
...
| 2 | SNC vs SNP | [`2_grupo2_snc_vs_snp.html`](./2_grupo2_snc_vs_snp.html) |
| 3 | Partes del Encéfalo | [`2_grupo3_partes_del_encefalo.html`](./2_grupo3_partes_del_encefalo.html) |
| 4 | Meninges y LCE | [`2_grupo4_meninges_lce_2.html`](./2_grupo4_meninges_lce_2.html) |
| 5 | NC II, III, IV | [`2_grupo5_NC_II_III_IV.html`](./2_grupo5_NC_II_III_IV.html) |
| 6 | NC V₁, VI, VII | [`2_grupo6_NC_V1_VI_VII.html`](./2_grupo6_NC_V1_VI_VII.html) |

---

## 🗂️ Ciclo 3 · Sistema Circulatorio *(22 – 23 de abril)*

> *Corazón · circulación mayor y menor · del corazón a la retina*
...
## 🔜 Ciclo 4 · Sistema Linfático — **PRÓXIMA SEMANA** *(29 – 30 de abril)*

> ### ⚠️ Importante para los estudiantes
> El **Sistema Linfático** es el tema de la **clase de la próxima semana**. La actividad se desarrollará **con los mismos 6 grupos** conformados para el trabajo del **Sistema Cardiovascular** (Ciclo 3). **No se reorganizarán los equipos.**
...
| Grupo | Tema asignado |
|:---:|:---|
| **1** | Organización general · vasos · conductos |
| **2** | Ganglio linfático · estructura, función y criterios clínicos |
| **3** | Drenaje cervicofacial y ocular · niveles de Robbins |
| **4** | Órganos linfoides · primarios & secundarios |
| **5** | MALT · CALT · EALT · LDALT |
...
- **Moore, K. L.** — *Anatomía con orientación clínica* (8.ª ed.) · Wolters Kluwer
- **Tortora, G. J. & Derrickson, B.** — *Principios de Anatomía y Fisiología* (15.ª ed.) · Ed. Médica Panamericana
- **Latarjet, M. & Ruiz Liard, A.** — *Anatomía Humana* (5.ª ed.) · Ed. Médica Panamericana
- **Rohen, J. W.** — *Atlas fotográfico de anatomía del cuerpo humano*

---

## 🧭 Cómo usar este repositorio

1. **Clona** el repositorio o descarga el archivo HTML del tema.
2. Abre el archivo directamente en tu navegador (Chrome, Firefox o Edge recientes).
3. Todos los materiales son **autocontenidos** — no requieren conexión a internet para funcionar (salvo fuentes tipográficas).
4. En móvil, preferir orientación vertical para lectura y horizontal para los esquemas interactivos.

---

## 📏 Acuerdos del curso

- 🕐 Margen de puntualidad: **10 minutos**
- 📱 Uso de dispositivos móviles: **solo con fines académicos**
- 📝 Evaluaciones con **rúbrica previa** + preguntas tipo **Saber Pro** + **una pregunta en inglés**
- 🤖 Uso **responsable y ético** de la inteligencia artificial

---

<sub>Morfología General · 2026-I · Dr. Jorge Bogoya · Universidad de La Salle</sub>
